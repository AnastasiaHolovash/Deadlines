...
class TimeLeftViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    let arrayOfColors2: [UIColor] = [#colorLiteral(red: 0.01235041414, green: 0.181724795, blue: 0.9385905774, alpha: 0.3813409675), #colorLiteral(red: 0, green: 0.9914394021, blue: 1, alpha: 0.4436001712), #colorLiteral(red: 0, green: 0.9768045545, blue: 0, alpha: 0.3017176798), #colorLiteral(red: 1, green: 0.2527923882, blue: 1, alpha: 0.3034567637), #colorLiteral(red: 1, green: 0.5763723254, blue: 0, alpha: 0.2952964469), #colorLiteral(red: 0.5791940689, green: 0.1280144453, blue: 0.5726861358, alpha: 0.2993899829), #colorLiteral(red: 0.9372549057, green: 0.3490196168, blue: 0.1921568662, alpha: 0.4001765839), #colorLiteral(red: 0.9994240403, green: 0.9433567303, blue: 0.2053000202, alpha: 0.5483465325), #colorLiteral(red: 0.4513868093, green: 0.9930960536, blue: 1, alpha: 0.4305436644)]
    var screenWigth = 500
...
//        setupStackView(stackView: horizontalStackView)
    ...
    func createHorisontalStackViewWithDates() -> UIStackView{
        ...
        screenWigth = (arrayOfTwoCellsStackView.count - 1) * 65 + 60
...
//        print("stackView.frame.width =  \(stackView.frame.width)")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if deadlines[indexPath.row].daysToDeadline >= 0{
            ...
            cell.nameLabel.text = "\(deadlines[indexPath.row].name) was missed"
            cell.colorView.backgroundColor = .red
            cell.viewWidth.constant = CGFloat(screenWigth)
        }
